/*  COMENTARIOS
 * 	- Percebi que a classe CreateAppletImage também possui strErrorMessage, porém como o método que muda essas mensagens de erro é privado e retorna um array de bytes,
 *  não soube como mudar para acrescentar no AspectJ. 
 */
